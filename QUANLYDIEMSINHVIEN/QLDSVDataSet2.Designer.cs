...
namespace QUANLYDIEMSINHVIEN {
    ...
    public partial class QLDSVDataSet2 : global::System.Data.DataSet {
        ...
        public partial class DIEMDataTable : global::System.Data.TypedTableBase<DIEMRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DIEMRow AddDIEMRow(double DIEM) {
        ...
        public partial class SINHVIENDataTable : global::System.Data.TypedTableBase<SINHVIENRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public SINHVIENRow AddSINHVIENRow(string MASV, string HO, string TEN) {
...
namespace QUANLYDIEMSINHVIEN.QLDSVDataSet2TableAdapters {
    ...
    public partial class DIEMTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT DIEM FROM dbo.DIEM";
        ...
        public virtual int Fill(QLDSVDataSet2.DIEMDataTable dataTable) {
        ...
        public virtual QLDSVDataSet2.DIEMDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLDSVDataSet2.DIEMDataTable dataTable = new QLDSVDataSet2.DIEMDataTable();
    ...
    public partial class SINHVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[SINHVIEN] WHERE (([MASV] = @Original_MASV) AND ((@IsNull_HO = " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[SINHVIEN] SET [MASV] = @MASV, [HO] = @HO, [TEN] = @TEN WHERE (([MASV] = @Original_MASV) AND ((@IsNull_HO = 1 AND [HO] IS NULL) OR ([HO] = @Original_HO)) AND ((@IsNull_TEN = 1 AND [TEN] IS NULL) OR ([TEN] = @Original_TEN)));
SELECT MASV, HO, TEN FROM SINHVIEN WHERE (MASV = @MASV)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT MASV, HO, TEN FROM dbo.SINHVIEN";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Delete(string Original_MASV, string Original_HO, string Original_TEN) {
        ...
        public virtual int Update(string MASV, string HO, string TEN, string Original_MASV, string Original_HO, string Original_TEN) {
            if ((MASV == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HO, string TEN, string Original_MASV, string Original_HO, string Original_TEN) {
            return this.Update(Original_MASV, HO, TEN, Original_MASV, Original_HO, Original_TEN);
        }
    }
